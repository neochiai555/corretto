...
public class Application extends AbstractHandler
{
    ...
    private void handleHttpRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        System.out.println("handleHttpRequest return");
        System.out.println("handleHttpRequest method = [" + request.getMethod() + "]");
        System.out.println("handleHttpRequest queryString = [" + request.getQueryString() + "]");
        System.out.println("handleHttpRequest parameterNames = [" + request.getParameterNames() + "]");
        System.out.println("handleHttpRequest parameterMap = [" + request.getParameterMap() + "]");
        System.out.println("handleHttpRequest headerNames = [" + request.getHeaderNames() + "]");
        ...
        System.out.println("handleHttpRequest body = [" + body + "]");
    ...
    private void handleCronTask(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        System.out.println("handleCronTask return");
